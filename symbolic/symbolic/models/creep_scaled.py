...
from symbolic.regression.expression import process_str, evaluate_expression, expression_to_latex
...
class Model(__Model__):
    ...
    def fit(self, data_list:list) -> None:
        ...
        * `data_list`: List of dictionaries containing data
        ...
        self.strain_julia = self.regressor.get_best()["equation"]
    ...
    def save_equation(self) -> str:
        ...
        with open(f"{self.output_path}/equation.txt", "w") as fh:
            fh.write(self.strain_julia)
        return self.strain_julia
    ...
    def predict(self, data_list:list) -> list:
        ...
        * `data_list`: List of dictionaries containing data
        ...
        # Initialise
        strain_julia = process_str(self.strain_julia)
