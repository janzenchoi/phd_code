"""
 Title:         The geodesic objective function
 Description:   The objective function for minimising the geodesic distance between two
...
from opt_all.maths.orientation import get_geodesic, euler_to_quat
...
class Error(__Error__):
    ...
    def initialise(self, eval_x_list:list):
        ...
        Parameters:
        * `eval_x_list`: The values to evaluate the geodesic distances
        """
