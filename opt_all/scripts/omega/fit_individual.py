...
for data in DATA_LIST:
    ...
    itf = Interface(f"omega_{data_info[1]}_{data_info[2]}", input_path="../data", output_path="../results")
    itf.define_model("omega/individual")

    # Bind parameters
    itf.bind_param(f"o1", 0, 100)
    itf.bind_param(f"o2", 0, 100)
    itf.bind_param(f"o3", 0, 100)
    itf.bind_param(f"o4", 0, 100)
