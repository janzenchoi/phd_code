...
class Model(__Model__):
    ...
    def get_response(self, cp_tau_s:float, cp_b:float, cp_tau_0:float, cp_n:float) -> dict:
    # def get_response(self, cp_tau_s:float, cp_b:float, cp_tau_0:float, cp_n:float, cp_gamma_0:float) -> dict:
        """
        ...
        * `...`: ...
        ...
        # Initialise
        param_list = [cp_tau_s, cp_b, cp_tau_0, cp_n]
        # param_list = [cp_tau_s, cp_b, cp_tau_0, cp_n, cp_gamma_0]
