"""
 Title:         The PyTorch Surrogate for the six-component latent hardening model
...
class Model(__Model__):
    ...
    def get_response(self, cp_lh_0:float, cp_lh_1:float, cp_lh_2:float, cp_lh_3:float,
                     cp_lh_4:float, cp_lh_5:float, cp_tau_0:float, cp_n:float) -> dict:
        """
        ...
        * `...`: ...
        ...
        # Initialise
        param_list = [cp_lh_0, cp_lh_1, cp_lh_2, cp_lh_3, cp_lh_4, cp_lh_5, cp_tau_0, cp_n]
