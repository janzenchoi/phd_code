...
# Results information
PARENT_PATH = "/mnt/c/Users/janzen/OneDrive - UNSW/H0419460/results/opt_all"
PARAMS_PATH = f"{PARENT_PATH}/2025-10-01 theta/params_fit.csv"
OPT_INDEX = 2
# PARAMS_PATH = f"{PARENT_PATH}/2025-10-01 theta_ox/params_fit.csv"
# OPT_INDEX = 4
OUTPUT_PATH = "../results"
...
def evaluate_model(stress, temperature, params):
    ...
    # Get parameters
    a1,b1,c1,d1,a2,b2,c2,d2,a3,b3,c3,d3,a4,b4,c4,d4 = params
