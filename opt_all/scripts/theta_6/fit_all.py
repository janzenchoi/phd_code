...
for _ in range(iters):
    ...
    OUTPUT_PATH = f"../results/{TIMESTAMP}_theta_6"
    safe_mkdir(OUTPUT_PATH)

    # OUTPUT_PATH = "../results/251006170647_theta_6"
    # OUTPUT_PATH = "../results/251006170834_theta_6"
    # OUTPUT_PATH = "../results/251006170837_theta_6"
    # OUTPUT_PATH = "../results/251006170839_theta_6"
    # OUTPUT_PATH = "../results/251006170841_theta_6"
    ...
    for data in DATA_LIST:
        ...
        itf = Interface(f"theta_6_{data_info[1]}_{data_info[2]}", input_path="../data", output_path=OUTPUT_PATH)
        itf.define_model("theta_6/individual")
    ...
    for pn in PARAM_NAMES:
        ...
        itf.define_model("theta_6/param", theta_param=pn)
