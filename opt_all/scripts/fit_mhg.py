...
# Initialise model
itf = Interface(f"mhg", input_path="data", output_path="results")
itf.define_model("mhg")

# Bind parameters
itf.bind_param(f"a0", 0e0, 1e3)
itf.bind_param(f"a1", 0e0, 1e3)
itf.bind_param(f"a2", 0e0, 1e3)
itf.bind_param(f"c",  0e0, 1e3)
