...
# Results information
PARAMS_PATH = "../results/2025-10-06 theta_mt/params_fit.csv"
OPT_INDEX = 4
OUTPUT_PATH = "../results"
...
def evaluate_model(stress, temperature, params):
    ...
    # Get parameters
    a1,b1,c1,d1,a2,b2,c2,d2,a3,b3,c3,d3,a4,b4,c4,d4,a5,n5,q5 = params
    get_t = lambda p1, p2, p3, p4 : np.exp(p1 + p2*stress + p3*temperature + p4*stress*temperature)
    get_t2 = lambda a, n, q : a*stress**n*np.exp(-q/8.314/temperature)
