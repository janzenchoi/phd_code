...
from opt_all.helper.general import transpose, csv_to_dict
from opt_all.io.plotter import define_legend, save_plot
from opt_all.io.pole_figure import get_lattice, IPF
from matplotlib.pyplot import figure

EXP_DATA_PATH = "data/617_ebsd/617_s3_40um_exp.csv"
ASMBO_PATH = "/mnt/c/Users/janzen/OneDrive - UNSW/H0419460/results/asmbo/2025-03-18 (vh_x_sm8_i41)"
SM_PATH = f"{ASMBO_PATH}/250318012854_i21_surrogate"
PARAM_INFO = [
...
def main():
    ...
    optimise(
        ...
        model_name  = "sm_617/sm_617_s3_vh",
        init_params = INIT_VALUES
    )

def optimise(train_path:str, exp_path:str, max_strain:float, grain_ids:list,
    ...
    * `init_params`: Initial parameter values
    ...
    itf = Interface(input_path=".", verbose=True)

    # Define mmodel
    itf.define_model(
        model_name = model_name,
        mms_path   = "/home/janzen/code/mms",
    ...
    itf.start_recorder(interval=1000, storage=50000)
